...
ui <- page_navbar(
  ...
  nav_panel(
    ...
    card(
      ...
      card_body(p("This app illustrates the broad range of potential impacts of changes in government spending and lump-sum tax / transfer payment multipliers in an aggregate economy."),
                ...
                tags$ol(
                  ...
                  p(HTML("* Note that the marginal propensity to export on the part of foreign consumers is assumed to be zero (for simplicity).")),
                  ),
                ...
                tags$ol(
                  ...
                  tags$li(HTML("The marginal propensity to consume (domestic goods & services only) is given by: MPC<sub>2</sub> = 1 - MTR - MPS<sub>2</sub> - MPI<sub>2</sub>")),
                  p(HTML("* Note that the marginal propensity to export on the part of foreign consumers is assumed to be zero (for simplicity).")),
                ),
